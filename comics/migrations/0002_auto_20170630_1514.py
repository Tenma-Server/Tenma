# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-06-30 19:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='issue',
            name='image',
            field=models.FilePathField(blank=True, path='media/images'),
        ),
        ...
        migrations.AlterField(
            model_name='character',
            name='teams',
            field=models.ManyToManyField(blank=True, related_name='characters', to='comics.Team'),
        ),
        migrations.AlterField(
            model_name='creator',
            name='desc',
        ...
        migrations.AlterField(
            model_name='issue',
            name='arcs',
            field=models.ManyToManyField(blank=True, related_name='issues', to='comics.Arc'),
        ),
        migrations.AlterField(
            model_name='issue',
            name='characters',
            field=models.ManyToManyField(blank=True, related_name='issues', to='comics.Character'),
        ),
        migrations.AlterField(
            model_name='issue',
            name='creators',
            field=models.ManyToManyField(blank=True, related_name='issues', to='comics.Creator'),
        ),
        migrations.AlterField(
            model_name='issue',
            name='date',
        ...
        migrations.AlterField(
            model_name='issue',
            name='series',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='issues', to='comics.Series'),
        ),
        migrations.AlterField(
            model_name='issue',
            name='teams',
            field=models.ManyToManyField(blank=True, related_name='issues', to='comics.Team'),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            model_name='series',
            name='publisher',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='series', to='comics.Publisher'),
        ),
        migrations.AlterField(
            model_name='series',
            name='year',
